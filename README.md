...
------------
   ...
   2. ```venv\Scripts\activate``` o ```venv\Scripts\activate.bat```
...
<div style="text-align: center;">
    ...
    <a href="mailto:david.nardelli.joel@gmail.com">
